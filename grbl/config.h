...
#if N_AXIS > 5
  #define AXIS_6 5
  #define AXIS_6_NAME 'X' // Letter of axis number 6
#endif
#if N_AXIS > 6
...
// NOTE: Defaults are set for a traditional 3-axis CNC machine. Z-axis first to clear, followed by X & Y.
  ...
  // #define HOMING_CYCLE_0 (1<<AXIS_3) // Home Z axis first to clear workspace.
  #define HOMING_CYCLE_0 ((1<<AXIS_1)|(1<<AXIS_2)|(1<<AXIS_6))     // OPTIONAL: uncomment to move X,Y at the same time.
  #define HOMING_CYCLE_1 (1<<AXIS_3) // Home Z axis  // OPTIONAL: uncomment to move only X at a time.
  //#define HOMING_CYCLE_2 (1<<AXIS_2) // Home Y axis  // OPTIONAL: uncomment to move only Y at a time.
  //#define HOMING_CYCLE_3 (1<<AXIS_4) // Home 4th axis (A)
  //#define HOMING_CYCLE_4 (1<<AXIS_5) // Home 5th axis (B)
